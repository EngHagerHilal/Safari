                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <div class="panel-heading text-center">
                                <h3 dir="{{$dir}}"><strong>{{__('frontEnd.sorry')}}</strong></h3>
                            </div>
                        </div>
                        <div style="border-radius: 10px" class="panel-body text-center bg-white m-lg-3 p-2 p-lg-5">
                            <p dir="{{$dir}}" class="font-1-2 text-center">
                                {{__('frontEnd.needToActive')}} <br>
                                <a class="btn btn-success" href="{{route('resend.email.activation')}}">{{__('frontEnd.sendActivation')}}</a>
                            </p>
                        </div>
                    </div>
                </div>

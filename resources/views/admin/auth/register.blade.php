                ...
                <div class="wrap-login100">
                    <form class="login100-form validate-form p-l-55 p-r-55 p-t-178"method="POST" action="{{ url('/admin/register') }}">
                        ...
                        <div class="wrap-input100 validate-input m-b-16" data-validate="Please enter username">
                            <input required class="input100 @error('name') is-invalid @enderror" type="text" value="{{old('name')}}" name="name" id="name" placeholder="{{__('frontEnd.your_name')}}">
                        ...
                        <div class="wrap-input100 validate-input m-b-16" data-validate="Please enter password">
                            <input class="@error('password_confirmation') is-invalid @enderror input100"
                                   id="password-confirm" placeholder="{{__('frontEnd.confirm_pass')}}"
